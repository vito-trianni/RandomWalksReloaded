...
class Results:
    ...
    def new_run( self ):
        ...
        self.distance_from_target.append(0)
        self.current_run += 1
    ...
    def store( self, convergence, time, conv_time, total_visits_fraction, percentage_tot_agents_with_info, first_passage_time_list,distance_from_target_matrix):
        ...
        self.distance_from_target[self.current_run]=distance_from_target_matrix
    ...
    def save( self, data_filename, run_filename ):
        ...
        distance_from_target=np.ma.array(self.distance_from_target)
        distance_from_target=distance_from_target.swapaxes(1,2)
        shape_data=distance_from_target.shape
        distance_from_target=distance_from_target.reshape(shape_data[0]*shape_data[1],shape_data[2])
        ...
        np.savetxt(new_filename, np.column_stack((distance_from_target)).T,
